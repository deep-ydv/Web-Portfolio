          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/deep-ydv/Intelliview-PrepAI" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Intelliview-PrepAI</h3>
              <p>
              IntelliView-PrepAI helps candidates prepare for interviews with AI-driven, role-specific questions,answers and coding examples.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/deep-ydv/TaskWave" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                <a href="https://taskwaves.vercel.app" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>TaskWave</h3>
              <p> TaskWave is a modern task management platform built for both Admins and Users. It allows administrators to efficiently assign, update, track, and report tasks, while users get a clear view of their responsibilities, progress, and deadlines — all in one responsive interface. </p>
            </div>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/deep-ydv/MovieInfo" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://movieinfo24.vercel.app" target="_blank" rel="noreferrer">
